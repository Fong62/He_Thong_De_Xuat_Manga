...
npm run dev
```
### 3. Cài đặt dêpndencies cho Back end
Vào thư mục src/api bạn sẽ thấy file requirements.txt 
Bật Terminal và chạy lệnh
```
pip install -r requirements.txt
```
### 4. Khởi động back end
Tìm vào thư mục src/api bạn sẽ thấy file main.py
bật Terminal và chạy lệnh 
```
python main.py
```
